...
export const validateGeneratedData = (countries, expectedCount = 196) => {
  const errors = [];
  const codes = new Set();
...
export const assertGeneratedData = (countries, expectedCount = 196) => {
  const errors = validateGeneratedData(countries, expectedCount);
  if (errors.length > 0) {
